...
<script type='text/javascript'>
 ...
 $(document).ready(function() {
	$("#region").change(function() {
			var url = '<?php echo url::base( true ). 'structure/kingdomprojects/' . $structure->id . '/' ?>';
				url += $('#region').val();
...
<div class="pagetitle"><?php echo kohana::lang('structures_actions.royalpalace_kingdomprojects') ?></div>
...
else
{
	...
	{	
		...
		echo html::image('media/images/structures/' . $kp -> cfgkingdomproject -> image, array('class' => 'size75') );
		echo "</div>";
