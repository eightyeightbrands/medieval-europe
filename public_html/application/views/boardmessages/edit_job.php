...
<br/>
<?php	echo form::textarea( array( 'id' => 'message', 'name' => 'message', 
'title' => kohana::lang('boardmessage.descriptionhelper'), 
'value' => $form['message'], 'rows' => 10, 'cols' => 90 ) ); ?>
<?php if (!empty ($errors['message'])) echo "<div class='error_msg'>".$errors['message']."</div>";?>
<br/>

<?php echo form::label( array( 'class' => 'form', 'name' => 'validity' ), 
kohana::lang('boardmessage.messagevalidity1') ); ?>
<?php echo form::hidden( 'validity', $form['validity']) ?>
<?php echo $form['validity'] ?> 
