...
<div class="pagetitle"><?php echo kohana::lang('kingdomforum.edittopic')?></div>

<?php echo html::image(array('src' => 'media/images/template/hruler.png')); ?>

<br/><br/>
<div id='breadcrumb'>
<?php echo html::anchor('region/kingdomboards/' . $currenttopic -> kingdom_forum_board -> kingdom_id, kohana::lang('kingdomforum.forumtitle', kohana::lang($currenttopic -> kingdom_forum_board -> kingdom -> name))) . ' > ' . kohana::lang('kingdomforum.edittopic');?>
</div>
<br/>

<?php echo form::open() ?>
<?php echo form::hidden('topic_id', $currenttopic -> id);?>
