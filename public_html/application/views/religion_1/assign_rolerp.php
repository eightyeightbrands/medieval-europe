...
<div id='helper'>
<?php echo kohana::lang('structures_religion_1.rolesandtitles_rolehelper') ?>
</div>


<div class='submenu'>
<?php echo html::anchor('/religion_1/assign_rolerp/' . $structure -> id, kohana::lang('structures_royalpalace.assignrolerp'),
