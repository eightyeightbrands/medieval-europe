<div class="row">
	<div class="col-xs-12">
		<div class="text-center">
			...
			<h1 class="text-center"><?php echo kohana::lang('user.resendvalidationtoken_pagetitle') ?></h1>
			...
			<p class="text-center"><?= kohana::lang('user.resendvalidationtoken_helper'); ?></p>
		</div>
</div>
<div class="row">
	<div class="col-xs-6 text-right">
		<?= form::open('/user/resendvalidationtoken', array('class' => 'form-inline')); ?>
	...
	<div class="col-xs-2 text-left">
		...
		<?=	form::submit(
					array (
						'id' => 'submitresendtoken' , 
						'name' => 'submitresendtoken',
						'class' => 'btn btn-me'),
