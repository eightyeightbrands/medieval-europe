...
<p class="pagination">
	...
	<?php if ($first_page): ?>
		<a href="<?php echo str_replace('{page}', $first_page, $url) ?>">&laquo;&nbsp;<?php echo Kohana::lang('pagination.first') ?></a>
	<?php else: ?>
		&laquo;&nbsp;<?php echo Kohana::lang('pagination.first') ?>
	<?php endif ?>

	<?php if ($previous_page): ?>
		<a href="<?php echo str_replace('{page}', $previous_page, $url) ?>">&lsaquo;&nbsp;<?php echo Kohana::lang('pagination.previous') ?></a>
	<?php else: ?>
		&lsaquo;&nbsp;<?php echo Kohana::lang('pagination.previous') ?>
	<?php endif ?>
	...
	<?php if ($next_page): ?>
		<a href="<?php echo str_replace('{page}', $next_page, $url) ?>"><?php echo Kohana::lang('pagination.next') ?>&nbsp;&rsaquo;</a>
	<?php else: ?>
		<?php echo Kohana::lang('pagination.next') ?>&nbsp;&rsaquo;
	<?php endif ?>
	
	<?php if ($last_page): ?>
			<a href="<?php echo str_replace('{page}', $last_page, $url) ?>"><?php echo Kohana::lang('pagination.last') ?>&nbsp;&raquo;</a>
	<?php else: ?>
		<?php echo Kohana::lang('pagination.last') ?>&nbsp;&raquo;
	<?php endif ?>
