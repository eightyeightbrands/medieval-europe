...
<div class='submenu'>
<?php echo html::anchor('/academy/assign_rolerp/' . $structure -> id, kohana::lang('structures_royalpalace.assignrolerp')); ?>
&nbsp;&nbsp;
...
<div id='helper'>
<?php echo kohana::lang('structures_academy.rolesandtitles_rolehelper') ?>
</div>
