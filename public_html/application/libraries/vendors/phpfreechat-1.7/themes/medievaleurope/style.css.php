...
div#pfc_container {
  ...
  background-image: url("<?php echo $c->getFileUrlFromTheme('images/background3.jpg'); ?>");  
  font-family: Times New Roman, Verdana, Sans-Serif; /* without this rule, the tabs are not correctly display on FF */
}
...
div#pfc_input_container td.pfc_td3 {
  padding-right: 5px;
  width: 20%;
}
...
p#pfc_handle {
	...
	font-size: 1.0em;          /* these two line fix a display problem in IE6 : */
	vertical-align: top;
	white-space: pre;
}
...
.pfc_info {
  ...
  /* https://sourceforge.net/tracker/index.php?func=detail&aid=1545403&group_id=158880&atid=809601 */
