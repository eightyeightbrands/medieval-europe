...
function pfc_make_hyperlink($text)
{
  ...
  $ret = preg_replace("#(^|[\n \]])((www|ftp)\.[\w\#$%&~/.\-;:=,?@+]*)#ise", "'\\1<a href=\"https://\\2\"" . $target . ">' . pfc_shorten_url('\\2') . '</a>'", $ret);
 ...
 * - Does not distinguish between "www.xxxx.yyyy" and "https://aaaa.bbbb" type URLs.
 *
 */
