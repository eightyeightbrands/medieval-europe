...
class RequestTest extends BaseTest
{
  ...
  {
    $url = 'https://localhost:8080/foo/bar?foo=a&foo=b&wowee=oh+my';
    $url2 = 'https://localhost:8080/foo/bar?foo=a&foo=b&wowee=oh+my&hi=there';
    ...
    $request->setBaseComponent("https://example.com");
    $this->assertEquals("https://example.com" . $urlPath, $request->getUrl());

    $url3a = 'https://localhost:8080/foo/bar';
    ...
    $url4 = 'https://localhost:8080/upload/foo/bar?foo=a&foo=b&wowee=oh+my&hi=there';
    $request = new Google_Http_Request($url);
    $this->assertEquals(2, count($request->getQueryParams()));
    $request->setQueryParam("hi", "there");
